...
describe('tests for groupBy', () => {
	...
	it('Return an object wich keys are the values that are the result of obtain the property gived like second argument', () => {
		const collection = [
	...
	it('Return an object wich keys are the values that are the result of execute te fuction gived like second argument', () => {
